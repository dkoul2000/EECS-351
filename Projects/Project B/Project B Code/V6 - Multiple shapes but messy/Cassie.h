...
void drawGndPlane(GLdouble siz, GLdouble xygap);
                                    // draw a grid of lines in the z=0 plane
                                    // spanning +/-siz, with grid spacing xygap.
void doCamChoice(int CamChoice);             // change to openGL camera specified by
                                    // global variable 'camChoice'
void crazyguybody(void);
void crazyguyarms(void);
void crazyguy(void);
void drawTire(void);
void TirePile(void);
...
void drawCone(void);
void totalCone(double height,double width);
